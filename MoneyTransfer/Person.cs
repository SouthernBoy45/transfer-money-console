...
namespace MoneyTransfer
{
    internal class Person
    {
        ...
        {
            //TODO 4: Use string interpolation in a Console.WriteLine to display the user's name and also the amount of money in their wallet (using dot notation). One line.
